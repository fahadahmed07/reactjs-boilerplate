...
class Home extends Component {
  state = {};
  render() {
    console.log("dsadsadad", this.props)
    return (
      <React.Fragment>
        <Navbar {...this.props} />
        <div className="row bgc f-bgc">
          <div className="container">
            <div className="row">
              <div
                className="col-sm-12 welcomto f-welcometo"
                style={{ fontfamily: "Calibri;color:#e2e2e2" }}
              >
                WELCOME TO{" "}
              </div>
            </div>
            ...
            <div className="row">
              <div
                className="col-sm-12 font-weight-bold imperative f-imperative f_med "
                style={{ color: "#2453ce" }}
              >
                IMPERATIVE
              </div>
            ...
            <div
              className="row systems f-systems"
              style={{ fontfamily: "Calibri;color:#e2e2e2 " }}
            >
              <div className="col-sm-12">SYSTEMS</div>
            </div>

            <div
              className="row mission f-mission"
            ...
            <div
              className="row"
              style={{ color: "#e2e2e2", fontsize: 22, fontfamily: "Calibri" }}
            >
              <div className="col-sm-12">
                <span className="btnx">GET A FREE DEMO ----></span>
              </div>
            </div>
          </div>
        </div>
